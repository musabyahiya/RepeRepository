...
<head>
   ...
   <title>Repa - Real Estate Professional Association of Pakistan - About</title>
        ...
        <div class="container">
            <div class="text-justify text-center">
              ...
              <br>
                ...
                <p class="pg">
                a. To cognize and promote Real Estate sector as an industry being the largest contributor to the economy of the country and the realtors associated with this 
                &nbsp;&nbsp;&nbsp;industry are duly certified by the authorized institution such as PIBSAT/SDC (Panjwani Institute of Business Studies and Technology affiliated with Skill 
                &nbsp;&nbsp;&nbsp;&nbsp;Development Council of Pakistan) as well as must be a member of REPA.</p>
                <p class="pg">
                b. To propose and to persuade the government of Pakistan through its concerned authorities to declare the real estate sector as an industry along with its
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;regulatory body and that a license followed by practitioner code must be issued to the certified realtors to practice within the prescribed parameters.
                </p>
                <p class="pg">
                c. To persuade the government (through its concerned authorities) to computerize the entire system of real estate transaction right from revenue department to
                &nbsp;&nbsp;&nbsp;&nbsp; the beneficiary’s data availability online. </p>
                <hr class="my-4">
