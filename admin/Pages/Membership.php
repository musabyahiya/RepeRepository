									...
									<div class="row">
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<input type="text" class="form-control txtMembershipNo" id="txtMembershipNo" placeholder="Enter your membership no">
											</div>
										</div>
									</div>
									<div class="card">
							...
							<div class="card-body FrmMembership_upd">
								<form id="ValidateMembership_upd" role="form">
									...
									<div class="row">
										...
										<div class="col-md-3">
											<div class="form-group">
												<label for="txtMembershipNo_upd">Membership No</label>
												<input type="text" class="form-control txtMembershipNo_upd" id="txtMembershipNo_upd" placeholder="Enter your membership no">
											</div>
										</div>
									</div>
									<div class="card">
	...
	<tr class="trMember">
		...
		<td class="project-title tdFileCNIC">
			<a href="#" download="${FileCNIC.trim()}">
				<img class="img-responsive" src="../upload/${FileCNIC.trim()}" download="${FileCNIC}" style="width:100px;">
			</a>
		</td>
